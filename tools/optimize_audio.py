...
Nutzung: Neue Audiodatei (mp3/wav/...) im Hauptordner ablegen, dann:

    python3 tools/optimize_audio.py <dateiname>

Erzeugt eine gleichnamige .ogg-Datei (Opus, 64 kbps, VBR, Metadaten/
Cover-Art entfernt) im Hauptordner. Loescht die Quelldatei NICHT
...
def optimize(fname):
    ...
    out_path = os.path.join(MAIN_DIR, base + '.ogg')
